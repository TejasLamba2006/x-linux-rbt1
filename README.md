...
### X-LINUX-RBT1 Software Features
...
- **application**:
    - **x_linux_rbt1**: This folder contains sources for the API and UI App.
    ...
    - **080-x-linux-rbt1.yaml**: Adds a menu entry to the default demo application that comes with the STM32MP evaluation/discovery boards.
...
![X-LINUX-RBT1 Icon](/_htmresc/07_x-linux-rbt1_icon_image.png "X-LINUX-SPN1 Launch Icon")
...
![X-LINUX-RBT1 Interface](/_htmresc/08_x-linux-rbt1_home_screen.png "X-LINUX-RBT1 GTK Application Interface")
...
![X-LINUX-RBT1 Interface](/_htmresc/09_x-linux-rbt1_control_screen.png "X-LINUX-RBT1 GTK Application Interface")
