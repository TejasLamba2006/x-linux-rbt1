...
class iis2dlpc:
    ...
    def __init__(self, enumerator):
            ...
            self.SSR_ACCEL_NAME = 'lis2dw12_accel'
    ...
    def accel_read(self):
        ...
        accel_x = xraw * self.accel_scale[0]*9.8/40
        accel_y = yraw * self.accel_scale[1]*9.8/40
        accel_z = zraw * self.accel_scale[2]*9.8/40
